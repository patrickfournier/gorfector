...
namespace Gorfector
{
    class Gorfector_PngWriterTestsFixture : public testing::Test
    {
    protected:
        ...
        void SetUp() override
        {
            ...
            if (testInfo != nullptr)
            {
                fileName = std::string(testInfo->test_suite_name()) + "_" + std::string(testInfo->name()) + ".png";
            }
    ...
    TEST_F(Gorfector_PngWriterTestsFixture, CanCreatePngWriter)
    {
        ...
        PngWriter writer(m_State, std::string(typeid(Gorfector_PngWriterTestsFixture).name()));
    ...
    TEST_F(Gorfector_PngWriterTestsFixture, CanWrite1bitPng)
    {
        SANE_Parameters saneParameters;
    ...
    TEST_F(Gorfector_PngWriterTestsFixture, CanWrite8BitColorPng)
    {
        SANE_Parameters saneParameters;
        SANE_Byte *buffer = nullptr;
        size_t bufferSize = 0;
    ...
    TEST_F(Gorfector_PngWriterTestsFixture, CanWrite8BitGrayscalePng)
    {
        SANE_Parameters saneParameters;
        SANE_Byte *buffer = nullptr;
        size_t bufferSize = 0;
    ...
    TEST_F(Gorfector_PngWriterTestsFixture, CanWrite16bitsColorPng)
    {
        SANE_Parameters saneParameters;
        SANE_Byte *buffer = nullptr;
        size_t bufferSize = 0;
    ...
    TEST_F(Gorfector_PngWriterTestsFixture, CanWrite16bitsGrayscalePng)
    {
        SANE_Parameters saneParameters;
        SANE_Byte *buffer = nullptr;
        size_t bufferSize = 0;
